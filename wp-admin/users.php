...
<ul>
	...
	<h1 class="wp-heading-inline">
		...
		if ( current_user_can( 'create_users' ) ) {
			?>
	<a href="<?php echo admin_url( 'user-new.php' ); ?>" class="page-title-action"><?php echo esc_html_x( 'Add ssss', 'user' ); ?></a>
	<a href="https://google.com" class="page-title-action"><?php echo esc_html_x( 'Clone', 'user' ); ?></a>
